...
#### Der  Vorwärtsflow
Hier startet man mit den Eingabedaten. Dabei wird Zufällig ein Vektor $x$ aus dem Trainingsdatensatz gewählt. Aus dem  Vektor$x$ und dem Gewichtsvektor $w_0=(0,0,0)$, wird die gewichtete Summe $s$ gebildet. Das ist nichts anderes als das Skalarprodukt aus zwei Vektoren. Dann führen wir die Heavysidefunktion ein, diese ist wie folgt definiert:
$$ 
step_0(s)= 
\begin{cases}
    1,& s	\geq 0\\
...
\end{cases}
$$
Mithilfe der Heavysidefunktion wird der Output berechnet. Anschließend wird das Perceptron noch traniert werden, dafür schauen wir uns den Rückwärtsflow an, dieser ist wie folgt:
#### Der  Rückwärtsflow
